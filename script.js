...
function cursorAnimation() {
  ...
  var initialVideoCursorLeft = videoCursor.style.left;
  var initialVideoCursorTop = videoCursor.style.top;
  ...
  videoContainer.addEventListener("mousemove", function (event) {
      var x = event.clientX - videoContainer.getBoundingClientRect().left;
      var y = event.clientY - videoContainer.getBoundingClientRect().top;
      gsap.to(videoCursor, {
        left: x,
        top: y,  
      });
  ...
  videoContainer.addEventListener("mouseleave", function () {
      ...
      gsap.to(videoCursor, { 
        left: initialVideoCursorLeft, 
        top: initialVideoCursorTop, 
        opacity: 1
      });
  });
